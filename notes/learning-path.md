...
| 080316 | 组合数学：卢卡斯定理 | 数学 | [math/lucas-theorem.md](math/lucas-theorem.md) |
...
| 090402 | 离散对数与 BSGS | 数学 | [math/discrete-logarithm.md](math/discrete-logarithm.md) |
| 090403 | 扩展卢卡斯定理 | 数学 | [math/extended-lucas-theorem.md](math/extended-lucas-theorem.md) |
...
| 090418 | 线性递推：Berlekamp-Massey | 数学 | [math/berlekamp-massey.md](math/berlekamp-massey.md) |
| 090419 | 线性规划与单纯形法 | 数学 | [math/linear-programming.md](math/linear-programming.md) |
...
| 090503 | 分治优化 | 动态规划 | [dynamic-programming/divide-conquer-optimization.md](dynamic-programming/divide-conquer-optimization.md) |
| 090504 | 四边形不等式优化 | 动态规划 | [dynamic-programming/quadrangle-inequality-optimization.md](dynamic-programming/quadrangle-inequality-optimization.md) |

...
<!-- legacy-drafts: 0101,0104,0105,0106,0107,0108,0109,0110,0111,0112,0113,0124,0125,0207,0304,0305,0306,0403,0501,0502,0503,0510 -->

## 01 C++ 基础

| ID | 知识点 | 状态 | 直接前置 | 文件 |
| --- | --- | --- | --- | --- |
| 0101 | 二进制存储、基本类型、浮点数与 ASCII | 草稿 | — | [0101-binary-types-floating-ascii.md](cpp/0101-binary-types-floating-ascii.md) |
| 0102 | 内存、地址、对象生命周期与存储期 | 计划 | 0101 | `cpp/0102-memory-address-lifetime.md` |
| 0103 | 位运算与 bitset | 计划 | 0101 | `cpp/0103-bit-operations-and-bitset.md` |
| 0104 | 程序入口与竞赛代码骨架 | 草稿 | 0101 | [0104-program-entry-and-skeleton.md](cpp/0104-program-entry-and-skeleton.md) |
| 0105 | 运算符与类型转换 | 草稿 | 0101,0104 | [0105-operators-and-conversions.md](cpp/0105-operators-and-conversions.md) |
...
| 0108 | 标准输入输出 | 草稿 | 0101,0104 | [0108-io.md](cpp/0108-io.md) |
...
| 0111 | 指针、引用与传参 | 草稿 | 0102,0107,0110 | [0111-pointers-references-parameters.md](cpp/0111-pointers-references-parameters.md) |
| 0112 | struct、enum 与复合类型 | 草稿 | 0101,0110 | [0112-composite-types.md](cpp/0112-composite-types.md) |
| 0113 | const、static 与常用修饰符 | 草稿 | 0102,0107,0111 | [0113-modifier-keywords.md](cpp/0113-modifier-keywords.md) |
| 0114 | 递归与调用栈 | 计划 | 0102,0107 | `cpp/0114-recursion-and-call-stack.md` |
| 0115 | pair、tuple 与 array | 计划 | 0110,0112 | `cpp/0115-pair-tuple-array.md` |
| 0116 | std::string | 计划 | 0110 | `cpp/0116-std-string.md` |
| 0117 | vector 与迭代器 | 计划 | 0110,0112 | `cpp/0117-vector-and-iterators.md` |
| 0118 | STL 算法与比较器 | 计划 | 0107,0117 | `cpp/0118-stl-algorithms-and-comparators.md` |
| 0119 | stack | 计划 | 0117 | `cpp/0119-stack.md` |
| 0120 | queue 与 deque | 计划 | 0117 | `cpp/0120-queue-and-deque.md` |
| 0121 | priority_queue | 计划 | 0117,0118 | `cpp/0121-priority-queue.md` |
| 0122 | set、multiset 与 map | 计划 | 0117,0118 | `cpp/0122-ordered-associative-containers.md` |
| 0123 | unordered_set 与 unordered_map | 计划 | 0117 | `cpp/0123-unordered-associative-containers.md` |
| 0124* | 编译单元、include 与头文件 | 草稿 | 0104 | [0124-include.md](cpp/0124-include.md) |
| 0125* | 命名空间与 std | 草稿 | 0124 | [0125-namespace-and-std.md](cpp/0125-namespace-and-std.md) |
| 0126* | GNU PBDS 与 order-statistics tree | 计划 | 0122 | `cpp/0126-gnu-pbds.md` |

## 02 基础算法与通用技巧

| ID | 知识点 | 状态 | 直接前置 | 文件 |
| --- | --- | --- | --- | --- |
| 0201 | 时间空间复杂度 | 计划 | 0101,0107 | `algorithm-basics/0201-complexity.md` |
...
| 0209 | 分治 | 计划 | 0114,0201 | `algorithm-basics/0209-divide-and-conquer.md` |
| 0210 | 枚举、回溯与剪枝 | 计划 | 0114,0201 | `algorithm-basics/0210-enumeration-backtracking.md` |
| 0211 | 子集与位掩码枚举 | 计划 | 0103,0210 | `algorithm-basics/0211-bitmask-enumeration.md` |
...
| 0302 | 二叉堆 | 计划 | 0110,0121,0201 | `data-structures/0302-binary-heap.md` |
| 0303 | 哈希表 | 计划 | 0110,0123,0201 | `data-structures/0303-hash-table.md` |
| 0304 | 线段树基础 | 草稿 | 0110,0114,0201 | [0304-segment-tree.md](data-structures/0304-segment-tree.md) |
| 0305* | 线段树懒标记的组合顺序 | 草稿 | 0304 | [0305-segment-tree-lazy-tags.md](data-structures/0305-segment-tree-lazy-tags.md) |
| 0306 | 树状数组 | 草稿 | 0103,0207,0201 | [0306-fenwick-tree.md](data-structures/0306-fenwick-tree.md) |
| 0307 | 并查集 | 计划 | 0110,0114,0201 | `data-structures/0307-disjoint-set-union.md` |
| 0308 | 稀疏表 ST | 计划 | 0110,0103,0201 | `data-structures/0308-sparse-table.md` |
| 0309 | 单调栈与单调队列 | 计划 | 0119,0120,0205 | `data-structures/0309-monotonic-stack-queue.md` |
| 0310 | 带权并查集 | 计划 | 0307 | `data-structures/0310-weighted-disjoint-set.md` |
| 0311 | 二叉树与前中后序遍历 | 计划 | 0111,0112,0114,0120 | `data-structures/0311-binary-tree-traversals.md` |
...
| 0327* | 启发式合并（small-to-large） | 计划 | 0122,0201 | `data-structures/0327-small-to-large-merging.md` |

## 04 图论

| ID | 知识点 | 状态 | 直接前置 | 文件 |
| --- | --- | --- | --- | --- |
| 0401 | 图的存储与边模型 | 计划 | 0117,0119 | `graph-theory/0401-graph-representation.md` |
| 0402 | DFS、BFS 与生成树 | 计划 | 0114,0120,0401 | `graph-theory/0402-dfs-bfs.md` |
| 0403 | 倍增 LCA | 草稿 | 0103,0402 | [0403-lca-binary-lifting.md](graph-theory/0403-lca-binary-lifting.md) |
...
| 0412 | 二分图匹配 | 计划 | 0114,0411 | `graph-theory/0412-bipartite-matching.md` |
...
| 0420 | 2-SAT | 计划 | 0103,0413 | `graph-theory/0420-two-sat.md` |
| 0421 | Dinic 最大流 | 计划 | 0114,0401,0406 | `graph-theory/0421-dinic-max-flow.md` |
| 0422* | 最小费用最大流 | 计划 | 0407,0421 | `graph-theory/0422-min-cost-max-flow.md` |
| 0423* | 虚树 | 计划 | 0403,0418 | `graph-theory/0423-virtual-tree.md` |
| 0424* | 点分治 | 计划 | 0114,0417 | `graph-theory/0424-centroid-decomposition.md` |
...
| 0504 | 模运算与快速幂 | 计划 | 0105,0103 | `math/0504-modular-arithmetic-fast-power.md` |
...
| 0513 | Nim、SG 函数与基础博弈论 | 计划 | 0103,0202 | `math/0513-nim-sg-game-theory.md` |
| 0514 | XOR 线性基 | 计划 | 0103,0202 | `math/0514-xor-linear-basis.md` |
...
| ID | 知识点 | 状态 | 直接前置 | 文件 |
| --- | --- | --- | --- | --- |
| 0601 | 坐标、点、向量与精度 | 计划 | 0101,0112,0202 | `computational-geometry/0601-points-vectors-precision.md` |
...
| 0608* | 几何扫描线 | 计划 | 0122,0214,0603 | `computational-geometry/0608-geometric-sweep-line.md` |
...
| 0709 | 数位 DP | 计划 | 0103,0701 | `dynamic-programming/0709-digit-dp.md` |
...
| ID | 知识点 | 状态 | 直接前置 | 文件 |
| --- | --- | --- | --- | --- |
| 0801 | 字符串比较与模式匹配问题 | 计划 | 0116,0201 | `strings/0801-string-matching-foundations.md` |

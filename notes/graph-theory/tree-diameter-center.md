...
[树：无根树](unrooted-trees.md) 中任意两个节点之间恰好只有一条路径。若要在一棵树上铺设一条覆盖范围尽量大的主干线路，自然会寻找树中最长的路径；若要设置一个服务点，让最远节点也尽量靠近，则需要寻找树的中心。
...
下一篇 [树：重心](tree-centroid.md) 会删除一个节点并观察剩余连通块的大小，寻找最能平衡整棵树的位置。
